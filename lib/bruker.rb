...
# Bruker.
#
# @see https://www.bruker.com/
module Bruker
  ###
  # Alias for +Bruker::XML::Document.parse(document)+.
  #
  # @param document [Nokogiri::XML::Document] an XML document
  # @return [Bruker::XML::Document, nil] representation of an XML document (on success), or +nil+ (on failure)
  def self.XML(document)
    Bruker::XML::Document.parse(document)
  end

  ###
  # TopSpin peak list (e.g., +peaklist.xml+).
  #
  ...
  module XML
    ...
    class Node
      class << self
        ...
        #
        # @param document [Nokogiri::XML::Document] an XML document
        # @return [Bruker::XML::Node, nil] representation of an XML node (on success), or +nil+ (on failure)
        def parse(document)
    ...
    #
    # @!attribute [rw] root
    #   @return [Bruker::XML::Nodes::PeakList] the root +<PeakList>+ XML node for this XML document
    class Document < Bruker::XML::Node
      class << self
        ###
        # Parse an XML document.
        #
        ...
        def parse(document)
          ...
          if !(root = document.root).nil? && !(result = Bruker::XML::Nodes::PeakList.parse(root)).nil?
            new(result)
          else
            nil
          end
      ...
      # Default constructor
      #
      # @param root [Bruker::XML::Nodes::PeakList] the root +<PeakList>+ XML node for this XML document
      def initialize(root)
        super()
    ...
    module Nodes
      ...
      #   @return [Array<Bruker::XML::Nodes::PeakList1D>] the list of children of this +<PeakList>+ XML node
      class PeakList < Bruker::XML::Node
        class << self
          ###
          # Parse an XML document.
          #
          # @param document [Nokogiri::XML::Document] an XML document
          # @return [Bruker::XML::Nodes::PeakList, nil] representation of +<PeakList>+ XML node (on success), or +nil+ (on failure)
          def parse(document)
            return nil if document.nil?
            ...
            children = document.xpath('PeakList1D').collect { |node|
              Bruker::XML::Nodes::PeakList1D.parse(node)
            }
        ...
        # @param children [Array<Bruker::XML::Nodes::PeakList1D>] the list of children of this +<PeakList>+ XML node
        ...
        def to_xml(document)
          ...
          node.set_attribute('modified', @modified.respond_to?(:strftime) ? @modified.strftime(Bruker::XML::DATETIME_FORMAT) : nil)
      ...
      #
      # @!attribute [rw] header
      #   @return [Bruker::XML::Nodes::PeakList1DHeader] the header for this +<PeakList1D>+ XML node
      # @!attribute [rw] children
      #   @return [Array<Bruker::XML::Nodes::Peak1D>] the list of children of this +<PeakList>+ XML node
      class PeakList1D < Bruker::XML::Node
        class << self
          ###
          # Parse an XML document.
          #
          # @param document [Nokogiri::XML::Document] an XML document
          # @return [Bruker::XML::Nodes::PeakList1D, nil] representation of +<PeakList1D>+ XML node (on success), or +nil+ (on failure)
          def parse(document)
            return nil if document.nil?
            return nil unless document.name == 'PeakList1D'

            header = document.xpath('PeakList1DHeader').collect { |node|
              Bruker::XML::Nodes::PeakList1DHeader.parse(node)
            }.first

            children = document.xpath('Peak1D').collect { |node|
              Bruker::XML::Nodes::Peak1D.parse(node)
            }
        ...
        # Default constructor.
        #
        # @param header [Bruker::XML::Nodes::PeakList1DHeader] the header for this +<PeakList1D>+ XML node
        # @param children [Array<Bruker::XML::Nodes::Peak1D>] the list of children of this +<PeakList>+ XML node
      ...
      #   @return [Bruker::XML::Nodes::PeakPickDetails] the +<PeakPickDetails>+ XML node for this +<PeakList1DHeader>+ XML node
      class PeakList1DHeader < Bruker::XML::Node
        class << self
          ###
          # Parse an XML document.
          #
          # @param document [Nokogiri::XML::Document] an XML document
          # @return [Bruker::XML::Nodes::PeakList1DHeader, nil] representation of +<PeakList1DHeader>+ XML node (on success), or +nil+ (on failure)
          def parse(document)
            return nil if document.nil?
            ...
            details = document.xpath('PeakPickDetails').collect { |node|
              Bruker::XML::Nodes::PeakPickDetails.parse(node)
            }.first
        ...
        # @param details [Bruker::XML::Nodes::PeakPickDetails] the +<PeakPickDetails>+ XML node for this +<PeakList1DHeader>+ XML node
        ...
        def to_xml(document)
          ...
          node.set_attribute('date', @date.respond_to?(:strftime) ? @date.strftime(Bruker::XML::DATETIME_FORMAT) : '')
      ...
      class PeakPickDetails < Bruker::XML::Node
        ###
        ...
        class << self
          ...
          #
          # @param document [Nokogiri::XML::Document] an XML document
          # @return [Bruker::XML::Nodes::PeakPickDetails, nil] representation of +<PeakPickDetails>+ XML node (on success), or +nil+ (on failure)
          def parse(document)
            return nil if document.nil?
      ...
      # @!attribute [rw] type
      #   @return [Fixnum] type
      class Peak1D < Bruker::XML::Node
        class << self
          ###
          # Parse an XML document.
          #
          # @param document [Nokogiri::XML::Document] an XML document
          # @return [Bruker::XML::Nodes::Peak1D, nil] representation of +<Peak1D>+ XML node (on success), or +nil+ (on failure)
          def parse(document)
            return nil if document.nil?
